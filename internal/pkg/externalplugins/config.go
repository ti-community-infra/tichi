...
type TiCommunityLgtm struct {
	...
	// IgnoreInvalidApprovalPrompt specifies no prompt when approval is invalid, default is `true`.
	IgnoreInvalidApprovalPrompt bool `json:"ignore_invalid_approval_prompt"`
}
