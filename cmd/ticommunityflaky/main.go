// Program  ticommunityflaky is a prow external plugin execute binary
// It supply flaky governance mechanism to force or encourage fixing flaky tests.
package main
...
import (
	...
	"github.com/ti-community-infra/tichi/internal/pkg/externalplugins/flaky"
...
func main() {
	...
	log := logrus.StandardLogger().WithField("plugin", flaky.PluginName)
	...
	helpProvider := flaky.HelpProvider(epa)
